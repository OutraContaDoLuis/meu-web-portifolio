...
import gifRetro from '../assets/gif-retro.gif'
...
function HomePage() {
    ...
    return (
        <>
            <div>
                <TopBar />
                <div class="div--home-page bg-green">
                ...
                <div class="div--home-page bg-dark p-5">
                    <h1 class="color-cyan ft-orbitron fw-bold">Projetos</h1>
                    <div class="d-flex">
                        <div class="card bg-dark-blue ft-rajdhani p-5 mx-5">
                        ...
                        <div class="card bg-dark-blue ft-rajdhani p-5 mx-3">
                            <p class="fs-4 color-cyan">CRUD Student System</p>
                            <p class="fs-2 color-red">Um CRUD com o backend feito em Java com o Framework SpringBoot e o Frontend 
                                feito em React.js com o framework css Bootstrap.
                            </p>
                ...
                <div class="div--home-page bg-white p-5">
